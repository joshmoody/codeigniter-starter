...
class Validation extends CI_Controller{
	...
	public function process()
	{
		...
		$viewdata = array();
		$this->form_validation->run($config_group);
		
		$viewdata['validation_rules'] = $this->form_validation->jquery_validate_rules($config_group);
		$viewdata['required_fields'] = json_encode($this->form_validation->get_required_fields($config_group), TRUE);
